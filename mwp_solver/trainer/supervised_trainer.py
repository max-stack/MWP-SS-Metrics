...
from trainer.template_trainer import TemplateTrainer
from utils.enum_type import TaskType, DatasetType, SpecialTokens
from utils.utils import time_since,write_json_data
...
class GTSTrainer(AbstractTrainer):
    ...
    def fit(self):
        ...
        return [test_equ_ac, test_val_ac]
