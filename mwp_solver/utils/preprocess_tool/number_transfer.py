...
# Function modified by Max Wilson-Hebben
...
# Function modified my Max Wilson-Hebben
def number_transfer_helper(data, mask_type, equ_split_symbol=";",vocab_level='word'):
    pattern = re.compile("\d*\(\d+/\d+\)\d*|\d+\.\d+%?|\d+%?|(-\d+)")
    
    seg = nltk.word_tokenize(data["segmented_text"])
